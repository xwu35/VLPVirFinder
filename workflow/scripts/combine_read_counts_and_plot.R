...
combined_table <- combined_table %>% 
  mutate(adapters_low_quality = total_raw_reads - total_reads_after_trimmomatic,
         ...
         reads_for_assembly = total_reads_after_human)
...
p_composition_reads <- combined_table %>%
  select(sample, adapters_low_quality, phiX, human, reads_for_assembly) %>%
...
output_table <- combined_table %>%
  select(sample, total_raw_reads, adapters_low_quality, phiX, human, reads_for_assembly) 
